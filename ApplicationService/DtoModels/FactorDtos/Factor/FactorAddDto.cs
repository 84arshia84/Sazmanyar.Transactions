...
namespace ApplicationService.DtoModels.FactorDtos.Factor
{
    public class FactorAddDto
    {
        ...
        public FactorTimeProfileAddDto FactorTimeProfile { get; set; }
        public FactorFinancialDetaileAddDto FactorFinancialDetaile { get; set; }
        public List<FactorServiceExplanationAddDto> FactorServiceExplanation { get; set; }
